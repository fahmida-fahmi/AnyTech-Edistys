...
const Footer = () => {
    return (
        <div className=''>
            ...
            <footer className='bg-[#142e4b] w-full '>
                <nav className='text-white py-10 xl:w-3/5 sm:w-4/5 w-4/5 mx-auto flex justify-between items-center'>
            ...
            <div className='bg-[#00152d] text-sky-400 py-4 border-t border-[#3f5c80]'>
                <div className='xl:w-3/5 sm:w-4/5 mx-auto lg:flex lg:justify-between  text-center items-center '>
                    <p className='text-sm font-semibold'>&copy; {new Date().getFullYear()}  All rights reserved. <span className='font-normal'> Any Technology Pte Ltd.</span></p>
                        ...
                        <p className='p-3'><a href="#" className=''>Privacy Policy</a></p>

...
const Banner = () => {
    ...
    return (
        <div className="relative  h-[86vh] flex items-center justify-center overflow-hidden">
            {/* Background Images */}
            ...
            ></div>
            <div
                className="absolute bottom-10 right-0 w-[200px] h-[200px] opacity-100"
                style={{
            ...
            {/* Content */}
            <div className="xl:w-3/5 sm:w-4/5 mx-auto relative z-10   ">
                ...
                <button className="mt-6 bg-orange-500 text-white px-6 py-3 rounded-md shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105">
                    Reach Out to Us →
                </button>
            </div>
        </div>

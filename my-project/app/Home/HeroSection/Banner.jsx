    ...
    return (
        <div className="">
            <div className="relative  lg:h-[86vh] h-[100vh] flex items-center justify-center overflow-hidden">
                {/* Background Images */}
                <div>
                    <div className="hidden lg:absolute inset-0 lg:flex justify-end">
                        <img
                            src={bgImage}
                ...
                <div className="lg:w-3/5 w-4/5 mx-auto relative z-10  lg:block lg:px-20">
            ...
            {/* <div>
                <div className="relative">
                    ...
                    <div className="-mt-10 lg:hidden  flex w-full">
                        <img
                            src={bgImage}
                            alt="Businesswoman background"
                            className="opacity-100"
                    ...
                    <svg className="absolute bottom-0 left-0 w-full h-40" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <polygon points="0,100 100,10 100,100 0,100" fill="black" />
                    </svg>
                    <svg className="absolute top-0 left-0 w-full h-40" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <polygon points="0,100 100,10 100,100 0,100" fill="black" />
                    </svg>
                </div>
